    ...
    <form class="text-left border border-light  z-depth-1 white" style="padding:0% 15% 0% 15%;"
        ...
        <div class="p-5">
            ...
            <div class="form-row mb-4">
                <div class="col">
                    <input type="text" id="NProveedor" name="nombre" class="form-control"
                        placeholder="Nombre del proveedor" value="{{ $proveedor->Nombre }}" required>
                </div>

            </div>
            <hr>

            <button class="btn btn-mdb-color py-3" style="text-transform: none; width:100%"> Editar proveedor</button>
        </div>
    </form>
</div>
</div>

...
<div class="border m-3">
    ...
    <form class="text-left border border-light  z-depth-1 white" style="padding:0% 15% 0% 15%;" action="/departamentos" method="POST">
        @csrf
        <div class="p-5">
            ...
            <div class="form-row mb-4">
                <div class="col">
                    <input type="text" id="NDepartamento" name="nombre" class="form-control" placeholder="Nombre del departamento" value="{{ old('nombre') }}" required>
                </div>

            </div>
            <hr>

            <button class="btn btn-mdb-color py-3" style="text-transform: none; width:100%"> Crear nuevo departamento</button>
        </div>
    </form>
</div>
</div>
